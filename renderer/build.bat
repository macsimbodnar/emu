...
set commonCompilerFlags=-MTd -Gm- -EHsc -WX -W4 -wd4201 -wd4100 -wd4505 -wd4189 -DHM_INTERNAL=1 -DHM_SLOW=1 -DHM_WIN32=1 -nologo -EHa- -GR- -Oi -FC -Z7 /Ilibs\windows\SDL\include
...
cl %commonCompilerFlags% test_pixello.cpp pixello.cpp /link libs\windows\SDL\lib\x64\SDL2.lib

xcopy /Y test_pixello.exe build\
xcopy /Y libs\windows\SDL\lib\x64\SDL2.dll build\